...
export default function VolunteerReportModal({
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      try {
        ...
        if (assignmentsData) {
          ...
          eventsAttended = new Set(
            assignmentsData
              .map((assignment: any) => assignment.shifts?.events?.title)
              .filter(Boolean)
          ).size;
          const sortedDates = assignmentsData
      ...
      const averageHoursPerEvent =
        eventsAttended > 0 ? totalHours / eventsAttended : 0;
      const firstVolunteerDate = volunteer.created_at;
      const daysSinceLastActivity =
        lastVolunteerDate !== "Never"
          ? Math.floor(
              (new Date().getTime() - new Date(lastVolunteerDate).getTime()) /
                (1000 * 60 * 60 * 24)
            )
          : 0;
        ...
        <body>
          ...
          <div class="section">
            ...
            <table class="table">
              ...
              <tbody>
                ${report.activities.recent_shifts
                  .slice(0, 10)
                  .map(
                    (activity) => `
                  <tr>
          ...
          <div class="section">
            ...
            <table class="table">
              ...
              <tbody>
                ${report.activities.recent_achievements
                  .map(
                    (achievement) => `
                  <tr>
            ...
            <>
              ...
              <div style={styles.section}>
                ...
                <div style={styles.grid}>
                  ...
                  <div style={styles.field}>
                    ...
                    <span style={styles.fieldValue}>
                      {report.volunteer.phone || "Not provided"}
                    </span>
                  </div>
                  <div style={styles.field}>
                    <span style={styles.fieldLabel}>Address</span>
                    <span style={styles.fieldValue}>
                      {formatAddress(report.volunteer.address)}
                    </span>
                  </div>
                  <div style={styles.field}>
                    <span style={styles.fieldLabel}>T-Shirt Size</span>
                    <span style={styles.fieldValue}>
                      {report.volunteer.t_shirt_size || "Not provided"}
                    </span>
                  </div>
                  <div style={styles.field}>
                    <span style={styles.fieldLabel}>Emergency Contact</span>
                    <span style={styles.fieldValue}>
                      {report.volunteer.emergency_contact_name ||
                        "Not provided"}
                      {report.volunteer.emergency_contact_phone &&
                        ` (${report.volunteer.emergency_contact_phone})`}
                    </span>
                  </div>
                </div>
              ...
              <div style={styles.section}>
                ...
                <div style={styles.field}>
                  ...
                  <span style={styles.fieldValue}>
                    {formatDate(report.summary.first_volunteer_date)}
                  </span>
                </div>
                <div style={styles.field}>
                ...
                <div style={styles.field}>
                  ...
                  <span style={styles.fieldValue}>
                    {formatDate(report.volunteer.created_at)}
                  </span>
                </div>
              </div>
              ...
              {report.activities.recent_achievements.length > 0 && (
                <div style={styles.section}>
                  ...
                  <table style={styles.table}>
                    ...
                    <tbody>
                      {report.activities.recent_achievements.map(
                        (achievement, index) => (
                          <tr key={index}>
              ...
              <div style={styles.section}>
                ...
                <div style={styles.grid}>
                  <div style={styles.field}>
                    ...
                    <span style={styles.fieldValue}>
                      {report.volunteer.skills &&
                      report.volunteer.skills.length > 0
