            ...
            <>
              ...
              <div style={styles.section}>
                ...
                <div style={styles.grid}>
                  ...
                  <div style={styles.field}>
                    ...
                    <span style={styles.fieldValue}>{volunteer.phone || 'Not provided'}</span>
                  </div>
                  <div style={styles.field}>
                    <span style={styles.fieldLabel}>Date of Birth</span>
                    <span style={styles.fieldValue}>
                      {volunteer.date_of_birth ? formatDate(volunteer.date_of_birth) : 'Not provided'}
                    </span>
                  </div>
                  <div style={styles.field}>
                    <span style={styles.fieldLabel}>Age</span>
                    <span style={styles.fieldValue}>
                      {volunteer.date_of_birth ? calculateAge(volunteer.date_of_birth) : 'Not provided'}
                    </span>
                  </div>
                  <div style={styles.field}>
                    <span style={styles.fieldLabel}>T-Shirt Size</span>
                    <span style={styles.fieldValue}>{volunteer.t_shirt_size || 'Not provided'}</span>
                  </div>
                </div>
              </div>
              ...
              <div style={styles.section}>
                ...
                <div style={styles.field}>
                  ...
                  <span style={styles.fieldValue}>{formatAddress(volunteer.address)}</span>
                </div>
              </div>
                    ...
                    <div style={styles.skillsContainer}>
                      {volunteer.tags && volunteer.tags.length > 0 ? (
                        volunteer.tags.map((tag, index) => (
                          <span key={index} style={styles.skillTag}>{tag}</span>
                        ))
                      ) : (
              ...
              <div style={styles.section}>
                ...
                <div style={styles.grid}>
                  ...
                  <div style={styles.field}>
                    ...
                    <span style={styles.fieldValue}>{volunteer.total_hours || 0} hours</span>
                  </div>
                  <div style={styles.field}>
                    <span style={styles.fieldLabel}>Events Attended</span>
                    <span style={styles.fieldValue}>{volunteer.events_attended || 0} events</span>
                  </div>
                  <div style={styles.field}>
                  ...
                  <div style={styles.grid}>
                    {onboardingStatus.map((item, index) => (
                      <div key={index} style={styles.field}>
                        <span style={styles.fieldLabel}>{item.onboarding_items?.title}</span>
                        <span style={{
                          ...styles.fieldValue,
                  ...
                  <div style={styles.grid}>
                    {recentActivities.map((activity, index) => (
                      <div key={index} style={styles.field}>
                        ...
                        <span style={styles.fieldValue}>
                          {activity.shifts?.title} - {formatDate(activity.created_at)}
                        </span>
                      </div>
                    ))}
                  </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Are you sure you want to change {volunteer.first_name} {volunteer.last_name}'s status to <strong>{pendingStatusChange}</strong>?
            </p>
            <div style={{
              display: 'flex',
              gap: '1rem',
