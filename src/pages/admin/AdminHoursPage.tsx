  ...
  const handleSearchVolunteers = async (search: string) => {
    ...
    try {
      const { data, error } = await supabase
        ...
        .or(
          `first_name.ilike.%${search}%,last_name.ilike.%${search}%,email.ilike.%${search}%,volunteer_number.ilike.%${search}%`
        )
        .eq("status", "active")
        .limit(10);
          ...
          {filteredLogs.length === 0 ? (
            ...
            filteredLogs.map((log) => (
              <div key={log.id} style={styles.tableRow}>
                ...
                <div style={styles.tableCell}>{log.description || "-"}</div>
                <div style={styles.tableCell}>
                  <span
                    style={{
                      ...styles.badge,
          ...
          >
            ...
            {!editingLog && (
              <div style={{ marginBottom: "1.5rem" }}>
                    ...
                    {volunteerSearchResults.map((vol) => (
                      <div
                        ...
                        onClick={() => {
                          ...
                          setVolunteerSearch(
                            `${vol.first_name} ${vol.last_name} (${vol.volunteer_number || vol.email})`
                          );
                          setVolunteerSearchResults([]);
                        }}
                        style={{
                      ...
                      >
                        ...
                        >
                          {vol.email}{" "}
                          {vol.volunteer_number && `• ${vol.volunteer_number}`}
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                {selectedVolunteer && (
                  ...
                  >
                    Selected: {selectedVolunteer.first_name}{" "}
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setHoursForm({ ...hoursForm, hours: e.target.value })
                }
                style={styles.searchInput}
                required
              />
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setHoursForm({ ...hoursForm, log_date: e.target.value })
                }
                style={styles.searchInput}
                required
              />
            ...
            <div style={{ marginBottom: "1rem" }}>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setHoursForm({ ...hoursForm, description: e.target.value })
                }
                style={{
                  ...styles.searchInput,
                  minHeight: "80px",
            ...
            <div style={{ marginBottom: "1.5rem" }}>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setHoursForm({ ...hoursForm, admin_notes: e.target.value })
                }
                style={{
                  ...styles.searchInput,
                  minHeight: "80px",
