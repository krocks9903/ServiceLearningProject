...
export default function ProfilePage() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      const totalHours =
        hourLogs?.reduce((sum, log) => sum + (log.hours || 0), 0) || 0;
    ...
    try {
      ...
      if (formData.email !== profile?.email) {
        ...
        if (authError) {
          ...
          setMessage({
            type: "error",
            text: "Profile updated but email change requires verification",
          });
        } else {
          setMessage({
            type: "success",
            text: "Profile updated! Please check your new email for verification link.",
          });
        }
      } else {
    ...
    <div style={styles.container}>
      ...
      >
        <div style={styles.heroContent}>
          ...
          <p style={styles.heroSubtitle}>Volunteer Profile & Settings</p>
          <div style={styles.statusBadgeContainer}>
            <span
              style={{
                ...styles.statusBadge,
                backgroundColor:
                  profile.status === "active" ? "#d1fae5" : "#fecaca",
              ...
              <div style={styles.infoGrid}>
                ...
                {(profile as any).volunteer_number && (
                  <div style={styles.infoItem}>
                    ...
                    >
                      Use this number for on-site check-in at volunteer
                      locations
                    </p>
                  </div>
                )}
                ...
                <div style={styles.infoItem}>
                  ...
                  <div style={styles.infoValue}>
                    {profile.t_shirt_size || "Not specified"}
                  </div>
                </div>
              ...
              {isEditing ? (
                <form onSubmit={handleSubmit} style={styles.form}>
                  ...
                  <div style={styles.formGroup}>
                    ...
                    />
                    <small style={styles.helpText}>
                      We'll use this to contact you about volunteer
                      opportunities
                    </small>
                  </div>
                ...
                <div style={styles.quickActions}>
                  ...
                  <button
                    onClick={() =>
                      window.open("/Volunteer Handbook 2025.pdf", "_blank")
                    }
                    style={styles.quickActionButton}
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.transform = "translateY(-2px)")
