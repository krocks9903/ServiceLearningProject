    ...
    <div style={styles.container}>
      ...
      <section style={styles.hero}>
        ...
        <p style={styles.heroSubtitle}>
          Join Harry Chapin Food Bank of SWFL volunteers making a difference in
          Southwest Florida
        </p>
      ...
      <section style={styles.section}>
        <div style={styles.missionBox}>
          ...
          >
            Harry Chapin Food Bank of SWFL's mission is to{" "}
            <strong style={{ fontWeight: "600", color: theme.colors.primary }}>
              lead our community in the fight to end hunger
            </strong>
            . We serve Charlotte, Collier, Glades, Hendry, and Lee counties,
            providing food assistance to those in need through our network of
        ...
        <div style={styles.programsGrid}>
          <div style={styles.programCard}>
            ...
            <div style={styles.programContent}>
              ...
              >
                About 32% of the people we serve are children. Hungry children
                have a hard time learning and developing.
              </p>
              <ul
                style={{
                  color: theme.colors.text.secondary,
          ...
          <div style={styles.programCard}>
            ...
            <div style={styles.programContent}>
              ...
              >
                Most of our clients are working families, struggling to make
                ends meet.
              </p>
              <ul
                style={{
          ...
          <div style={styles.programCard}>
            ...
            <div style={styles.programContent}>
              ...
              >
                About 19% of the people we serve are seniors. They often choose
        ...
        <div style={{ marginTop: "4rem" }}>
          ...
          >
            ...
            <div style={{ marginTop: "1.5rem" }}>
              ...
              >
                This online feature gives you an easy way to keep-in-touch with
                the volunteer program. You can schedule yourself, check your
                schedule, post your volunteer service, receive messages, and
                much more: anytime, and from any device.
              </p>
              <div
                style={{
          ...
          >
            ...
            >
              ...
              <div style={{ marginTop: "1.5rem" }}>
                ...
                >
                  If you are a new volunteer or have not been through our
                  Orientation, please review this document for more information.
                  The Volunteer Handbook is your extensive guide to volunteering
                  at HCFB!
                </p>
                <a
            ...
            >
              ...
              <div style={{ marginTop: "1.5rem" }}>
                ...
                >
                  Here is the Operations Manual for our Fulfill Mobile Pantries
                  (FMP). Volunteers that attend FMP should review this manual
                  for complete operating guidelines and procedures.
                </p>
                <a
          ...
          >
            ...
            >
              Volunteers make it possible for the food bank to feed a quarter of
              a million people a month in Southwest Florida. They sort and pack
              donations, distribute food at mobile pantries, and collect
              donations at food drives.
            </p>
          </div>
      ...
      >
        ...
        >
            ...
            {user ? (
              <>
                ...
                <strong
                  style={{ fontWeight: "600", color: theme.colors.primary }}
                >
                  30,000+ hours annually
                </strong>
                . Schedule your volunteer shift today and help us feed{" "}
                <strong
                  style={{ fontWeight: "600", color: theme.colors.primary }}
                >
                  250,000+ people monthly
                </strong>
                .
              </>
            ) : (
              <>
                ...
                . Sign up today to schedule your volunteer shift and help us
                feed{" "}
                <strong
                  style={{ fontWeight: "600", color: theme.colors.primary }}
                >
          ...
          >
            ...
            >
              <strong>Important:</strong> All volunteering must be scheduled in
              advance. Contact Angelina Codi, Volunteer Coordinator, for more
              information.
            </p>
          </div>
        </div>
